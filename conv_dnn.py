# THEANO_FLAGS=mode=FAST_RUN,device=gpu,floatX=float32 python conv_dnn.py
...
network = L.layers.Conv1DLayer(network,num_filters=50,filter_size=10,stride=9)
...
for epoch in range(0,100):
    ...
    batch_size=10
    for i in range(0,train_data.shape[0]-batch_size,batch_size): 
        reshape=np.reshape(train_data[i:i+batch_size],(10,1,99))
